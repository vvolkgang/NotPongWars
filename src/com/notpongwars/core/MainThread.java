...
public class MainThread extends Thread {
	...
	public static final String TAG = "[CORE]" + MainThread.class.getSimpleName();
	...
	// Decimal formater for delta value from last frame
    //private DecimalFormat dfDt = new DecimalFormat("0.##");
	...
	/**
	 * Sets whether or not the thread should be running.
	 * 
	 * @param running
	 */
