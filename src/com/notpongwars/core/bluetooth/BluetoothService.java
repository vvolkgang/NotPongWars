...
public class BluetoothService extends Observable  {
    // Debugging
    private static final String TAG = "MessageTypeService";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME = "MessageType";

    // Unique UUID for this application
    private static final UUID MY_UUID = UUID.fromString("9a2f573a-27b4-42ee-a16e-04c3e0cfe75e");
    ...
    /**
     * Constructor. Prepares a new MessageType session.
